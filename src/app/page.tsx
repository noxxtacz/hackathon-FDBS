...
const featureKeys = [
  {
    titleKey: "feature.phishing",
    descKey: "feature.phishingDesc",
    href: "/phishing",
    icon: (
  ...
  {
    titleKey: "feature.reports",
    descKey: "feature.reportsDesc",
    href: "/reports",
    icon: (
  ...
  {
    titleKey: "feature.vault",
    descKey: "feature.vaultDesc",
    href: "/vault",
    icon: (
      ...
      <section className="relative flex flex-col items-center pb-16 pt-12 text-center sm:pt-20">
        ...
        <div className="relative">
          ...
          <h1 className="mx-auto max-w-3xl text-4xl font-extrabold leading-tight tracking-tight text-white sm:text-5xl lg:text-6xl">
            {t("home.title1", language)}{" "}
            <span className="bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-transparent">
              {t("home.title2", language)}
            </span>
          </h1>
